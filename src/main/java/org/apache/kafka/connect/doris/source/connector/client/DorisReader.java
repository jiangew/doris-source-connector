...
public interface DorisReader {
    ...
    default List<org.apache.kafka.connect.doris.source.connector.model.DorisRowWithTypes> fetchRecordsWithTypes(String sql, String seqColumn) throws SQLException {
